...
class AppLocalizations {
  ...
  static const _localizedValues = <String, Map<String, String>>{
    'en': {
      ...
      // Safety Check
      'safety_check_title': 'Email Safety Check',
      'safety_check_pii': 'PII Protection',
      'safety_check_phishing': 'Anti-Phishing',
      'safety_check_accuracy': 'Information Accuracy',
      'safety_check_tone': 'Professional Tone',
      'safety_check_compliance': 'Compliance',
      'safety_pass': 'PASS',
      'safety_fail': 'FAIL',
      'safety_overall_safe': 'SAFE TO SEND',
      'safety_overall_warning': 'NEEDS REVIEW',
      'safety_overall_unsafe': 'UNSAFE - DO NOT SEND',
      'safety_pii_pass': 'No sensitive data detected',
      'safety_pii_fail': 'Sensitive data found: {details}',
      'safety_phishing_pass': 'No phishing indicators',
      'safety_phishing_fail': 'Phishing risk: {details}',
      'safety_accuracy_pass': 'All claims verifiable',
      'safety_accuracy_fail': 'Unverified claims: {details}',
      'safety_tone_pass': 'Professional tone maintained',
      'safety_tone_fail': 'Unprofessional tone: {details}',
      'safety_compliance_pass': 'Compliant with regulations',
      'safety_compliance_fail': 'Compliance issues: {details}',
    },
    'vi': {
      'app_title': 'WardMail',
      ...
      // Safety Check
      'safety_check_title': 'Kiểm tra An toàn Email',
      'safety_check_pii': 'Bảo vệ PII',
      'safety_check_phishing': 'Chống Lừa đảo',
      'safety_check_accuracy': 'Độ chính xác',
      'safety_check_tone': 'Văn phong',
      'safety_check_compliance': 'Tuân thủ',
      'safety_pass': 'ĐẠT',
      'safety_fail': 'KHÔNG ĐẠT',
      'safety_overall_safe': 'AN TOÀN ĐỂ GỬI',
      'safety_overall_warning': 'CẦN XEM XÉT',
      'safety_overall_unsafe': 'KHÔNG AN TOÀN',
      'safety_pii_pass': 'Không phát hiện dữ liệu nhạy cảm',
      'safety_pii_fail': 'Phát hiện dữ liệu nhạy cảm: {details}',
      'safety_phishing_pass': 'Không phát hiện dấu hiệu lừa đảo',
      'safety_phishing_fail': 'Nguy cơ lừa đảo: {details}',
      'safety_accuracy_pass': 'Thông tin có thể xác minh',
      'safety_accuracy_fail': 'Thông tin chưa xác minh: {details}',
      'safety_tone_pass': 'Văn phong chuyên nghiệp',
      'safety_tone_fail': 'Văn phong thiếu chuyên nghiệp: {details}',
      'safety_compliance_pass': 'Tuân thủ các quy định',
      'safety_compliance_fail': 'Vấn đề tuân thủ: {details}',
    },
  };
